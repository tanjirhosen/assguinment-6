...
const displayHandle = (direction,id) =>{
  ...
  const getInput = () =>{
    const getIn = document.getElementById('text_box');
    const getValue = getIn.value;
    const url = `https://openapi.programming-hero.com/api/phones?search=${getValue}`
   console.log(url);
  fetch(url)
      ...
      for(const phone of phones){
        if(count<20){
          ...
          div.classList.add("col");
            div.innerHTML=`
                  <div class="card">
                    <img src=${phone.photo} class="card-img-top" alt="...">
                    <div class="card-body">
